  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "scale-in-center-4":
          "scale-in-center 0.5s cubic-bezier(0.250, 0.460, 0.450, 0.940) 2s both",
        "scale-in-center-5":
          "scale-in-center 0.5s cubic-bezier(0.250, 0.460, 0.450, 0.940) 2.5s both",
        "scale-in-center-6":
          "scale-in-center 0.5s cubic-bezier(0.250, 0.460, 0.450, 0.940) 3s both",
